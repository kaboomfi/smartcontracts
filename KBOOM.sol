...
interface IERC20 {
     ...
     * transaction ordering. One possible solution to mierate this race
...
// KBOOMToken with Governance.
contract KaboomFinance is ERC20("Kaboom Finance", "KBOOM"), Ownable {
    uint256 private _cap = 2200000e18;
    uint256 private _initial_supply = 250000e18;
    ...
    */
    ...
    // In some circumstance, we should not burn KBOOM on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
    ...
    constructor() public {
        ...
        _mint(msg.sender, _initial_supply); // Mint 3000 KBOOM for bounty program
